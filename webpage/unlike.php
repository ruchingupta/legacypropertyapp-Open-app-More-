...
$query = "SELECT id,Like__c,Number_of_Bathrooms__c,Number_Of_Bedrooms__c,Price__c,Property_Image__c,Sold__c,Type__c,Zipcode__c,Address__c,Image_URL__c,MLS__c from Property_Detail__c WHERE id='".$attId."' AND Like__c = true";
	...
	$content = json_encode(array('Like__c' => 'false'));
